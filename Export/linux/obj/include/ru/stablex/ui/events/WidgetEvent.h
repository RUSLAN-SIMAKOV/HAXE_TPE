...
class HXCPP_CLASS_ATTRIBUTES WidgetEvent_obj : public  ::openfl::events::Event_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"ru.stablex.ui.events.WidgetEvent"); }
		static ::hx::ObjectPtr< WidgetEvent_obj > __new(::String type, ::ru::stablex::ui::widgets::Widget widget);
		static ::hx::ObjectPtr< WidgetEvent_obj > __alloc(::hx::Ctx *_hx_ctx,::String type, ::ru::stablex::ui::widgets::Widget widget);
		...
		::String __ToString() const { return HX_("WidgetEvent",96,79,0a,e6); }
