...
HX_DEFINE_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_454_new,"openfl.events.TouchEvent","new",0xe223a0c4,"openfl.events.TouchEvent.new","openfl/events/TouchEvent.hx",454,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_476_clone,"openfl.events.TouchEvent","clone",0x1a12c4c1,"openfl.events.TouchEvent.clone","openfl/events/TouchEvent.hx",476,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_487_toString,"openfl.events.TouchEvent","toString",0x9efd15c8,"openfl.events.TouchEvent.toString","openfl/events/TouchEvent.hx",487,0x2fe85d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_498_updateAfterEvent,"openfl.events.TouchEvent","updateAfterEvent",0xeb0abce3,"openfl.events.TouchEvent.updateAfterEvent","openfl/events/TouchEvent.hx",498,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_512___init,"openfl.events.TouchEvent","__init",0x9cbf244c,"openfl.events.TouchEvent.__init","openfl/events/TouchEvent.hx",512,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_502___create,"openfl.events.TouchEvent","__create",0x8acd1738,"openfl.events.TouchEvent.__create","openfl/events/TouchEvent.hx",502,0x2fe85d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_411_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",411,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_412_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",412,0x2fe85d0c)
namespace openfl{
namespace events{
...
void TouchEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< int >  __o_touchPointID,::hx::Null< bool >  __o_isPrimaryTouchPoint,::hx::Null< Float >  __o_localX,::hx::Null< Float >  __o_localY,::hx::Null< Float >  __o_sizeX,::hx::Null< Float >  __o_sizeY,::hx::Null< Float >  __o_pressure, ::openfl::display::InteractiveObject relatedObject,::hx::Null< bool >  __o_ctrlKey,::hx::Null< bool >  __o_altKey,::hx::Null< bool >  __o_shiftKey,::hx::Null< bool >  __o_commandKey,::hx::Null< bool >  __o_controlKey,::hx::Null< Float >  __o_timestamp,::String touchIntent, ::openfl::utils::ByteArrayData samples,::hx::Null< bool >  __o_isTouchPointCanceled){
            	...
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_454_new)
HXLINE( 455)		super::__construct(type,bubbles,cancelable);
HXLINE( 457)		this->touchPointID = touchPointID;
HXLINE( 458)		this->isPrimaryTouchPoint = isPrimaryTouchPoint;
HXLINE( 459)		this->localX = localX;
HXLINE( 460)		this->localY = localY;
HXLINE( 461)		this->sizeX = sizeX;
HXLINE( 462)		this->sizeY = sizeY;
HXLINE( 463)		this->pressure = pressure;
HXLINE( 464)		this->relatedObject = relatedObject;
HXLINE( 465)		this->ctrlKey = ctrlKey;
HXLINE( 466)		this->altKey = altKey;
HXLINE( 467)		this->shiftKey = shiftKey;
HXLINE( 468)		this->commandKey = commandKey;
HXLINE( 469)		this->controlKey = controlKey;
HXLINE( 471)		this->stageX = ::Math_obj::NaN;
HXLINE( 472)		this->stageY = ::Math_obj::NaN;
            	}
...
bool TouchEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TouchEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_476_clone)
HXLINE( 477)		 ::openfl::events::TouchEvent event =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->touchPointID,this->isPrimaryTouchPoint,this->localX,this->localY,this->sizeX,this->sizeY,this->pressure,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->commandKey,this->controlKey,null(),null(),null(),null());
HXLINE( 479)		event->target = this->target;
HXLINE( 480)		event->currentTarget = this->currentTarget;
HXLINE( 481)		event->eventPhase = this->eventPhase;
HXLINE( 482)		return event;
            	}


::String TouchEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_487_toString)
HXDLIN( 487)		return this->_hx___formatToString(HX_("TouchEvent",fb,af,06,66),::Array_obj< ::String >::fromData( _hx_array_data_e5132ed2_3,16));
            	}


void TouchEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_498_updateAfterEvent)
            	}
...
void TouchEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_512___init)
HXLINE( 513)		this->super::_hx___init();
HXLINE( 514)		this->touchPointID = 0;
HXLINE( 515)		this->isPrimaryTouchPoint = false;
HXLINE( 516)		this->localX = ( (Float)(0) );
HXLINE( 517)		this->localY = ( (Float)(0) );
HXLINE( 518)		this->sizeX = ( (Float)(0) );
HXLINE( 519)		this->sizeY = ( (Float)(0) );
HXLINE( 520)		this->pressure = ( (Float)(0) );
HXLINE( 521)		this->relatedObject = null();
HXLINE( 522)		this->ctrlKey = false;
HXLINE( 523)		this->altKey = false;
HXLINE( 524)		this->shiftKey = false;
HXLINE( 525)		this->commandKey = false;
HXLINE( 526)		this->controlKey = false;
HXLINE( 528)		this->stageX = ::Math_obj::NaN;
HXLINE( 529)		this->stageY = ::Math_obj::NaN;
            	}
...
::String TouchEvent_obj::TOUCH_TAP;
 ...
 ::lime::utils::ObjectPool TouchEvent_obj::_hx___pool;
 ...
 ::openfl::events::TouchEvent TouchEvent_obj::_hx___create(::String type, ::Dynamic touch,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_502___create)
HXLINE( 503)		 ::openfl::events::TouchEvent evt =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,type,true,false,0,true,local->x,local->y,1,1,1,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 504)		evt->stageX = stageX;
HXLINE( 505)		evt->stageY = stageY;
HXLINE( 506)		evt->target = target;
HXLINE( 508)		return evt;
            	}
...
static ::hx::StaticInfo TouchEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool */ ,(void *) &TouchEvent_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void TouchEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(TouchEvent_obj::_hx___pool,"__pool");
};
...
static void TouchEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(TouchEvent_obj::_hx___pool,"__pool");
};
            	...
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::events::TouchEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_411_boot)
HXDLIN( 411)			return  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::events::TouchEvent event){
            			HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_412_boot)
HXLINE( 412)			event->_hx___init();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_411_boot)
HXDLIN( 411)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
