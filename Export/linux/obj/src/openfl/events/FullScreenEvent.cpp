...
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_61_boot,"openfl.events.FullScreenEvent","boot",0x9eb49cf8,"openfl.events.FullScreenEvent.boot","openfl/events/FullScreenEvent.hx",61,0x5d391076)
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_62_boot,"openfl.events.FullScreenEvent","boot",0x9eb49cf8,"openfl.events.FullScreenEvent.boot","openfl/events/FullScreenEvent.hx",62,0x5d391076)
namespace openfl{
namespace events{
...
::String FullScreenEvent_obj::FULL_SCREEN_INTERACTIVE_ACCEPTED;
 ...
 ::lime::utils::ObjectPool FullScreenEvent_obj::_hx___pool;
...
static ::hx::StaticInfo FullScreenEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool */ ,(void *) &FullScreenEvent_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void FullScreenEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(FullScreenEvent_obj::_hx___pool,"__pool");
};
...
static void FullScreenEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(FullScreenEvent_obj::_hx___pool,"__pool");
};
            	...
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::events::FullScreenEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_9acd580c71eb88b0_61_boot)
HXDLIN(  61)			return  ::openfl::events::FullScreenEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::events::FullScreenEvent event){
            			HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_62_boot)
HXLINE(  62)			event->_hx___init();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_9acd580c71eb88b0_61_boot)
HXDLIN(  61)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
