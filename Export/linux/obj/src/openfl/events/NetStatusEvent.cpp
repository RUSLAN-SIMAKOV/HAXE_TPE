...
HX_LOCAL_STACK_FRAME(_hx_pos_27135fd1b85393b6_127_boot,"openfl.events.NetStatusEvent","boot",0x8a3a477e,"openfl.events.NetStatusEvent.boot","openfl/events/NetStatusEvent.hx",127,0xf85a9d3c)
HX_LOCAL_STACK_FRAME(_hx_pos_27135fd1b85393b6_128_boot,"openfl.events.NetStatusEvent","boot",0x8a3a477e,"openfl.events.NetStatusEvent.boot","openfl/events/NetStatusEvent.hx",128,0xf85a9d3c)
namespace openfl{
namespace events{
...
::String NetStatusEvent_obj::NET_STATUS;
 ...
 ::lime::utils::ObjectPool NetStatusEvent_obj::_hx___pool;
...
bool NetStatusEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
...
bool NetStatusEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
...
static ::hx::StaticInfo NetStatusEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool */ ,(void *) &NetStatusEvent_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void NetStatusEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(NetStatusEvent_obj::_hx___pool,"__pool");
};
...
static void NetStatusEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(NetStatusEvent_obj::_hx___pool,"__pool");
};
...
void NetStatusEvent_obj::__register()
{
	...
	__mClass->mGetStaticField = &NetStatusEvent_obj::__GetStatic;
	__mClass->mSetStaticField = &NetStatusEvent_obj::__SetStatic;
            	...
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::events::NetStatusEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_27135fd1b85393b6_127_boot)
HXDLIN( 127)			return  ::openfl::events::NetStatusEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::events::NetStatusEvent event){
            			HX_STACKFRAME(&_hx_pos_27135fd1b85393b6_128_boot)
HXLINE( 128)			event->_hx___init();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_27135fd1b85393b6_127_boot)
HXDLIN( 127)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
