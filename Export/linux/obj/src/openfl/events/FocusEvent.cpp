...
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_141_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",141,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_142_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",142,0xe559e625)
namespace openfl{
namespace events{
...
::String FocusEvent_obj::MOUSE_FOCUS_CHANGE;
 ...
 ::lime::utils::ObjectPool FocusEvent_obj::_hx___pool;
...
static ::hx::StaticInfo FocusEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool */ ,(void *) &FocusEvent_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void FocusEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(FocusEvent_obj::_hx___pool,"__pool");
};
...
static void FocusEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(FocusEvent_obj::_hx___pool,"__pool");
};
            	...
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::events::FocusEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_141_boot)
HXDLIN( 141)			return  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::events::FocusEvent event){
            			HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_142_boot)
HXLINE( 142)			event->_hx___init();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_141_boot)
HXDLIN( 141)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
