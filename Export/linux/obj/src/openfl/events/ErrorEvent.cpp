...
HX_DEFINE_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_75_new,"openfl.events.ErrorEvent","new",0x1354a39b,"openfl.events.ErrorEvent.new","openfl/events/ErrorEvent.hx",75,0x9d2fc215)
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_81_clone,"openfl.events.ErrorEvent","clone",0xbbab6b58,"openfl.events.ErrorEvent.clone","openfl/events/ErrorEvent.hx",81,0x9d2fc215)
...
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_95___init,"openfl.events.ErrorEvent","__init",0x60b841d5,"openfl.events.ErrorEvent.__init","openfl/events/ErrorEvent.hx",95,0x9d2fc215)
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_42_boot,"openfl.events.ErrorEvent","boot",0xced38497,"openfl.events.ErrorEvent.boot","openfl/events/ErrorEvent.hx",42,0x9d2fc215)
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_51_boot,"openfl.events.ErrorEvent","boot",0xced38497,"openfl.events.ErrorEvent.boot","openfl/events/ErrorEvent.hx",51,0x9d2fc215)
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_52_boot,"openfl.events.ErrorEvent","boot",0xced38497,"openfl.events.ErrorEvent.boot","openfl/events/ErrorEvent.hx",52,0x9d2fc215)
namespace openfl{
namespace events{
...
void ErrorEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::String __o_text,::hx::Null< int >  __o_id){
            	...
            	HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_75_new)
HXLINE(  76)		super::__construct(type,bubbles,cancelable,text);
HXLINE(  77)		this->errorID = id;
            	}
...
bool ErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_81_clone)
HXLINE(  82)		 ::openfl::events::ErrorEvent event =  ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
...
void ErrorEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_95___init)
HXLINE(  96)		this->super::_hx___init();
HXLINE(  97)		this->errorID = 0;
            	}


::String ErrorEvent_obj::ERROR;

 ::lime::utils::ObjectPool ErrorEvent_obj::_hx___pool;
...
static ::hx::StaticInfo ErrorEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool */ ,(void *) &ErrorEvent_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            	HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_42_boot)
HXDLIN(  42)		ERROR = HX_("error",c8,cb,29,73);
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::events::ErrorEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_51_boot)
HXDLIN(  51)			return  ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::events::ErrorEvent event){
            			HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_52_boot)
HXLINE(  52)			event->_hx___init();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_51_boot)
HXDLIN(  51)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
