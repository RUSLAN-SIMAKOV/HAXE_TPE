...
::String ProgressEvent_obj::SOCKET_DATA;
 ...
 ::lime::utils::ObjectPool ProgressEvent_obj::_hx___pool;
...
static ::hx::StaticInfo ProgressEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool */ ,(void *) &ProgressEvent_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void ProgressEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(ProgressEvent_obj::_hx___pool,"__pool");
};
...
static void ProgressEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(ProgressEvent_obj::_hx___pool,"__pool");
};
            	...
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::events::ProgressEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_b09527e17bebd012_67_boot)
HXDLIN(  67)			return  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null());
            		}
...
HXLINE(  68)			event->_hx___init();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b09527e17bebd012_67_boot)
HXDLIN(  67)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
