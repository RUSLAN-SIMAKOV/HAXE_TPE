...
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_134_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",134,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_135_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",135,0xce5f4702)
namespace openfl{
namespace events{
...
::String KeyboardEvent_obj::KEY_UP;
 ...
 ::lime::utils::ObjectPool KeyboardEvent_obj::_hx___pool;
...
static ::hx::StaticInfo KeyboardEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool */ ,(void *) &KeyboardEvent_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void KeyboardEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(KeyboardEvent_obj::_hx___pool,"__pool");
};
...
static void KeyboardEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(KeyboardEvent_obj::_hx___pool,"__pool");
};
            	...
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::events::KeyboardEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_c70c2341539e31f3_134_boot)
HXDLIN( 134)			return  ::openfl::events::KeyboardEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::events::KeyboardEvent event){
            			HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_135_boot)
HXLINE( 135)			event->_hx___init();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_c70c2341539e31f3_134_boot)
HXDLIN( 134)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
