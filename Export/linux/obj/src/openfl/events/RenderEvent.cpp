...
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_131_boot,"openfl.events.RenderEvent","boot",0x385e9a33,"openfl.events.RenderEvent.boot","openfl/events/RenderEvent.hx",131,0xf57c28f1)
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_132_boot,"openfl.events.RenderEvent","boot",0x385e9a33,"openfl.events.RenderEvent.boot","openfl/events/RenderEvent.hx",132,0xf57c28f1)
namespace openfl{
namespace events{
...
::String RenderEvent_obj::RENDER_OPENGL;
 ...
 ::lime::utils::ObjectPool RenderEvent_obj::_hx___pool;
...
static ::hx::StaticInfo RenderEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool */ ,(void *) &RenderEvent_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void RenderEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(RenderEvent_obj::_hx___pool,"__pool");
};
...
static void RenderEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(RenderEvent_obj::_hx___pool,"__pool");
};
            	...
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::events::RenderEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_6a559adcb74b53ca_131_boot)
HXDLIN( 131)			return  ::openfl::events::RenderEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::events::RenderEvent event){
            			HX_STACKFRAME(&_hx_pos_6a559adcb74b53ca_132_boot)
HXLINE( 132)			event->_hx___init();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_6a559adcb74b53ca_131_boot)
HXDLIN( 131)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
