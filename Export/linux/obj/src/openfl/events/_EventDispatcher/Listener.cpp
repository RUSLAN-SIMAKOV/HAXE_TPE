...
HX_LOCAL_STACK_FRAME(_hx_pos_4056b9d72619ced0_555_match,"openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",555,0xe2270714)
...
bool Listener_obj::match( ::Dynamic callback,bool useCapture){
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_555_match)
HXDLIN( 555)		if (::Reflect_obj::compareMethods(this->callback,callback)) {
HXDLIN( 555)			return (this->useCapture == useCapture);
            		}
            		else {
