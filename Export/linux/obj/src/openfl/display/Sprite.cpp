...
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_174_startDrag,"openfl.display.Sprite","startDrag",0x20ea0c37,"openfl.display.Sprite.startDrag","openfl/display/Sprite.hx",174,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_215_stopDrag,"openfl.display.Sprite","stopDrag",0x4d02dd75,"openfl.display.Sprite.stopDrag","openfl/display/Sprite.hx",215,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_236___getCursor,"openfl.display.Sprite","__getCursor",0x4a69b9ed,"openfl.display.Sprite.__getCursor","openfl/display/Sprite.hx",236,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_241___hitTest,"openfl.display.Sprite","__hitTest",0x895417e6,"openfl.display.Sprite.__hitTest","openfl/display/Sprite.hx",241,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_280___hitTestHitArea,"openfl.display.Sprite","__hitTestHitArea",0x980a9c3a,"openfl.display.Sprite.__hitTestHitArea","openfl/display/Sprite.hx",280,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_302___hitTestMask,"openfl.display.Sprite","__hitTestMask",0x9c046ff2,"openfl.display.Sprite.__hitTestMask","openfl/display/Sprite.hx",302,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_317_get_graphics,"openfl.display.Sprite","get_graphics",0x451134b3,"openfl.display.Sprite.get_graphics","openfl/display/Sprite.hx",317,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_328_get_tabEnabled,"openfl.display.Sprite","get_tabEnabled",0x5c66fc94,"openfl.display.Sprite.get_tabEnabled","openfl/display/Sprite.hx",328,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_333_get_buttonMode,"openfl.display.Sprite","get_buttonMode",0xceb5485d,"openfl.display.Sprite.get_buttonMode","openfl/display/Sprite.hx",333,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_338_set_buttonMode,"openfl.display.Sprite","set_buttonMode",0xeed530d1,"openfl.display.Sprite.set_buttonMode","openfl/display/Sprite.hx",338,0xd5438ced)
namespace openfl{
namespace display{
...
HXLINE( 148)		this->_hx___buttonMode = false;
HXLINE( 149)		this->useHandCursor = true;
            	}
...
void Sprite_obj::startDrag(::hx::Null< bool >  __o_lockCenter, ::openfl::geom::Rectangle bounds){
            	...
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_174_startDrag)
HXDLIN( 174)		if (::hx::IsNotNull( this->stage )) {
HXLINE( 176)			this->stage->_hx___startDrag(::hx::ObjectPtr<OBJ_>(this),lockCenter,bounds);
            		}
            	}
...
void Sprite_obj::stopDrag(){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_215_stopDrag)
HXDLIN( 215)		if (::hx::IsNotNull( this->stage )) {
HXLINE( 217)			this->stage->_hx___stopDrag(::hx::ObjectPtr<OBJ_>(this));
            		}
            	}
...
::String Sprite_obj::_hx___getCursor(){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_236___getCursor)
HXDLIN( 236)		bool _hx_tmp;
HXDLIN( 236)		if (this->_hx___buttonMode) {
HXDLIN( 236)			_hx_tmp = this->useHandCursor;
            		}
            		else {
...
bool Sprite_obj::_hx___hitTest(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_241___hitTest)
HXLINE( 242)		bool _hx_tmp;
HXDLIN( 242)		bool _hx_tmp1;
HXDLIN( 242)		if (interactiveOnly) {
HXLINE( 242)			_hx_tmp1 = !(this->mouseEnabled);
            		}
            		else {
HXLINE( 242)			_hx_tmp1 = false;
            		}
HXDLIN( 242)		if (_hx_tmp1) {
HXLINE( 242)			_hx_tmp = !(this->mouseChildren);
            		}
            		else {
...
HXDLIN( 243)		if (hitObject->get_visible()) {
HXLINE( 243)			_hx_tmp2 = this->_hx___isMask;
            		}
            		else {
HXLINE( 243)			_hx_tmp2 = true;
            		}
HXDLIN( 243)		if (_hx_tmp2) {
HXLINE( 243)			return this->_hx___hitTestHitArea(x,y,shapeFlag,stack,interactiveOnly,hitObject);
            		}
HXLINE( 244)		bool _hx_tmp3;
HXDLIN( 244)		if (::hx::IsNotNull( this->get_mask() )) {
HXLINE( 244)			_hx_tmp3 = !(this->get_mask()->_hx___hitTestMask(x,y));
            		}
            		else {
...
HXLINE( 246)		if (::hx::IsNotNull( this->_hx___scrollRect )) {
HXLINE( 248)			 ::openfl::geom::Point point = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
HXLINE( 249)			point->setTo(x,y);
HXLINE( 250)			{
HXLINE( 250)				 ::openfl::geom::Matrix _this = this->_hx___getRenderTransform();
HXDLIN( 250)				Float norm = ((_this->a * _this->d) - (_this->b * _this->c));
HXDLIN( 250)				if ((norm == 0)) {
HXLINE( 250)					point->x = -(_this->tx);
HXDLIN( 250)					point->y = -(_this->ty);
            				}
            				else {
HXLINE( 250)					Float px = ((((Float)1.0) / norm) * ((_this->c * (_this->ty - point->y)) + (_this->d * (point->x - _this->tx))));
HXDLIN( 250)					point->y = ((((Float)1.0) / norm) * ((_this->a * (point->y - _this->ty)) + (_this->b * (_this->tx - point->x))));
HXDLIN( 250)					point->x = px;
            				}
            			}
HXLINE( 252)			if (!(this->_hx___scrollRect->containsPoint(point))) {
HXLINE( 254)				::openfl::geom::Point_obj::_hx___pool->release(point);
HXLINE( 255)				return this->_hx___hitTestHitArea(x,y,shapeFlag,stack,true,hitObject);
            			}
HXLINE( 258)			::openfl::geom::Point_obj::_hx___pool->release(point);
            		}
HXLINE( 261)		if (this->super::_hx___hitTest(x,y,shapeFlag,stack,interactiveOnly,hitObject)) {
HXLINE( 263)			if (::hx::IsNotNull( stack )) {
HXLINE( 263)				return interactiveOnly;
            			}
            			else {
...
HXDLIN( 265)			if (::hx::IsNull( this->hitArea )) {
HXLINE( 265)				_hx_tmp1 = ::hx::IsNotNull( this->_hx___graphics );
            			}
            			else {
HXLINE( 265)				_hx_tmp1 = false;
            			}
HXDLIN( 265)			if (_hx_tmp1) {
HXLINE( 265)				 ::openfl::display::Graphics _hx_tmp1 = this->_hx___graphics;
HXDLIN( 265)				_hx_tmp = _hx_tmp1->_hx___hitTest(x,y,shapeFlag,this->_hx___getRenderTransform());
            			}
            			else {
...
HXDLIN( 267)				if (::hx::IsNotNull( stack )) {
HXLINE( 267)					if (interactiveOnly) {
HXLINE( 267)						_hx_tmp = this->mouseEnabled;
            					}
            					else {
...
HXLINE( 269)					stack->push(hitObject);
            				}
HXLINE( 272)				return true;
            			}
            		}
HXLINE( 275)		return this->_hx___hitTestHitArea(x,y,shapeFlag,stack,interactiveOnly,hitObject);
            	}
...
bool Sprite_obj::_hx___hitTestHitArea(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_280___hitTestHitArea)
HXLINE( 281)		if (::hx::IsNotNull( this->hitArea )) {
HXLINE( 283)			if (!(this->hitArea->mouseEnabled)) {
HXLINE( 285)				this->hitArea->mouseEnabled = true;
HXLINE( 286)				bool hitTest = this->hitArea->_hx___hitTest(x,y,shapeFlag,null(),true,hitObject);
HXLINE( 287)				this->hitArea->mouseEnabled = false;
HXLINE( 289)				bool _hx_tmp;
HXDLIN( 289)				if (::hx::IsNotNull( stack )) {
HXLINE( 289)					_hx_tmp = hitTest;
            				}
            				else {
HXLINE( 289)					_hx_tmp = false;
            				}
HXDLIN( 289)				if (_hx_tmp) {
HXLINE( 291)					stack[stack->length] = hitObject;
            				}
HXLINE( 294)				return hitTest;
            			}
            		}
...
bool Sprite_obj::_hx___hitTestMask(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_302___hitTestMask)
HXLINE( 303)		if (this->super::_hx___hitTestMask(x,y)) {
HXLINE( 305)			return true;
            		}
            		else {
HXLINE( 307)			bool _hx_tmp;
HXDLIN( 307)			if (::hx::IsNotNull( this->_hx___graphics )) {
HXLINE( 307)				 ::openfl::display::Graphics _hx_tmp1 = this->_hx___graphics;
HXDLIN( 307)				_hx_tmp = _hx_tmp1->_hx___hitTest(x,y,true,this->_hx___getRenderTransform());
            			}
            			else {
...
HXLINE( 312)		return false;
 ...
 ::openfl::display::Graphics Sprite_obj::get_graphics(){
            	HX_GC_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_317_get_graphics)
HXLINE( 318)		if (::hx::IsNull( this->_hx___graphics )) {
HXLINE( 320)			this->_hx___graphics =  ::openfl::display::Graphics_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 323)		return this->_hx___graphics;
            	}
...
bool Sprite_obj::get_tabEnabled(){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_328_get_tabEnabled)
HXDLIN( 328)		if (::hx::IsNull( this->_hx___tabEnabled )) {
HXDLIN( 328)			return this->_hx___buttonMode;
            		}
            		else {
HXDLIN( 328)			return ( (bool)(this->_hx___tabEnabled) );
            		}
...
bool Sprite_obj::get_buttonMode(){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_333_get_buttonMode)
HXDLIN( 333)		return this->_hx___buttonMode;
            	}
...
bool Sprite_obj::set_buttonMode(bool value){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_338_set_buttonMode)
HXDLIN( 338)		return (this->_hx___buttonMode = value);
            	}
