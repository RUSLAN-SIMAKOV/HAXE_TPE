...
HXLINE(1482)				_hx_tmp = ::Std_obj::isOfType(this->_hx___focus,( ( ::Dynamic)(::hx::ClassOf< ::openfl::display::Sprite >()) ));
            			}
            			else {
...
HXLINE(1587)										if (::Std_obj::isOfType(sibling,( ( ::Dynamic)(::hx::ClassOf< ::openfl::display::InteractiveObject >()) ))) {
