...
bool ShaderBuffer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x3cd483b4;
}
...
HXLINE( 172)				 ::openfl::_internal::renderer::ShaderBuffer _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 188)				 ::openfl::_internal::renderer::ShaderBuffer _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
