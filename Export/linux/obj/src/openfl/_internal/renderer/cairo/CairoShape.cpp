...
bool CairoShape_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x036bc8da;
}
...
HXLINE(  48)					_hx_tmp1 = (transform->b == 0);
            				}
            				else {
HXLINE(  48)					_hx_tmp1 = false;
            				}
HXDLIN(  48)				if (_hx_tmp1) {
HXLINE(  48)					_hx_tmp = (transform->c == 0);
            				}
            				else {
...
HXLINE( 110)						_hx_tmp = (centerHeight != 0);
            					}
            					else {
...
HXLINE( 125)							_hx_tmp = (centerHeight != 0);
            						}
            						else {
...
HXLINE( 133)								_hx_tmp = (centerWidth != 0);
            							}
            							else {
...
HXLINE( 148)					 ::lime::graphics::cairo::Cairo cairo1 = cairo;
HXDLIN( 148)					cairo1->setSourceSurface(graphics->_hx___cairo->get_target(),( (Float)(0) ),( (Float)(0) ));
