...
HX_DEFINE_STACK_FRAME(_hx_pos_0f667a7c675195ce_861_new,"openfl._internal.formats.agal._AGALConverter.SamplerRegister","new",0xe06db1fa,"openfl._internal.formats.agal._AGALConverter.SamplerRegister.new","openfl/_internal/formats/agal/AGALConverter.hx",861,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_0f667a7c675195ce_880_toGLSL,"openfl._internal.formats.agal._AGALConverter.SamplerRegister","toGLSL",0x0e5bf39f,"openfl._internal.formats.agal._AGALConverter.SamplerRegister.toGLSL","openfl/_internal/formats/agal/AGALConverter.hx",880,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_0f667a7c675195ce_886_toSamplerState,"openfl._internal.formats.agal._AGALConverter.SamplerRegister","toSamplerState",0x99da12aa,"openfl._internal.formats.agal._AGALConverter.SamplerRegister.toSamplerState","openfl/_internal/formats/agal/AGALConverter.hx",886,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_0f667a7c675195ce_864_parse,"openfl._internal.formats.agal._AGALConverter.SamplerRegister","parse",0x40de8c4d,"openfl._internal.formats.agal._AGALConverter.SamplerRegister.parse","openfl/_internal/formats/agal/AGALConverter.hx",864,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_0f667a7c675195ce_848_boot,"openfl._internal.formats.agal._AGALConverter.SamplerRegister","boot",0x77a70958,"openfl._internal.formats.agal._AGALConverter.SamplerRegister.boot","openfl/_internal/formats/agal/AGALConverter.hx",848,0x323dd368)
namespace openfl{
namespace _internal{
namespace formats{
namespace agal{
...
void SamplerRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0f667a7c675195ce_861_new)
            	}
...
bool SamplerRegister_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x06f9ed5a;
}

::String SamplerRegister_obj::toGLSL(){
            	HX_STACKFRAME(&_hx_pos_0f667a7c675195ce_880_toGLSL)
HXLINE( 881)		::String str = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::renderer::SamplerState SamplerRegister_obj::toSamplerState(){
            	HX_GC_STACKFRAME(&_hx_pos_0f667a7c675195ce_886_toSamplerState)
...
HXLINE( 940)		return  ::openfl::_internal::renderer::SamplerState_obj::__alloc( HX_CTX ,wrap,filter,mipfilter,lodBias,ignoreSampler,centroid,textureAlpha);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toSamplerState,return )
 ...
 ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister SamplerRegister_obj::parse( cpp::Int64Struct v, ::openfl::_internal::formats::agal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_0f667a7c675195ce_864_parse)
HXLINE( 865)		 ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister sr =  ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );
...
{
{
            	HX_STACKFRAME(&_hx_pos_0f667a7c675195ce_848_boot)
