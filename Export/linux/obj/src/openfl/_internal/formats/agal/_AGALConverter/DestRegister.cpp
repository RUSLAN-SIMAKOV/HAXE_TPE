...
HX_DEFINE_STACK_FRAME(_hx_pos_2c9b0c284e068689_541_new,"openfl._internal.formats.agal._AGALConverter.DestRegister","new",0x710dba3a,"openfl._internal.formats.agal._AGALConverter.DestRegister.new","openfl/_internal/formats/agal/AGALConverter.hx",541,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_2c9b0c284e068689_544_getWriteMask,"openfl._internal.formats.agal._AGALConverter.DestRegister","getWriteMask",0x170bdcdb,"openfl._internal.formats.agal._AGALConverter.DestRegister.getWriteMask","openfl/_internal/formats/agal/AGALConverter.hx",544,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_2c9b0c284e068689_564_toGLSL,"openfl._internal.formats.agal._AGALConverter.DestRegister","toGLSL",0x15be935f,"openfl._internal.formats.agal._AGALConverter.DestRegister.toGLSL","openfl/_internal/formats/agal/AGALConverter.hx",564,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_2c9b0c284e068689_554_parse,"openfl._internal.formats.agal._AGALConverter.DestRegister","parse",0x3fc1248d,"openfl._internal.formats.agal._AGALConverter.DestRegister.parse","openfl/_internal/formats/agal/AGALConverter.hx",554,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_2c9b0c284e068689_534_boot,"openfl._internal.formats.agal._AGALConverter.DestRegister","boot",0x730e3918,"openfl._internal.formats.agal._AGALConverter.DestRegister.boot","openfl/_internal/formats/agal/AGALConverter.hx",534,0x323dd368)
namespace openfl{
namespace _internal{
namespace formats{
namespace agal{
...
void DestRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_2c9b0c284e068689_541_new)
            	}
...
bool DestRegister_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x16634db6;
}

::String DestRegister_obj::getWriteMask(){
            	HX_STACKFRAME(&_hx_pos_2c9b0c284e068689_544_getWriteMask)
...
::String DestRegister_obj::toGLSL(::hx::Null< bool >  __o_useMask){
            	...
            	HX_STACKFRAME(&_hx_pos_2c9b0c284e068689_564_toGLSL)
HXLINE( 565)		::String str;
HXLINE( 567)		if ((this->type == 3)) {
HXLINE( 569)			if (::hx::IsEq( this->programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
...
HXLINE( 573)			::String str1 = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
...
HX_DEFINE_DYNAMIC_FUNC1(DestRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::formats::agal::_AGALConverter::DestRegister DestRegister_obj::parse(int v, ::openfl::_internal::formats::agal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_2c9b0c284e068689_554_parse)
HXLINE( 555)		 ::openfl::_internal::formats::agal::_AGALConverter::DestRegister dr =  ::openfl::_internal::formats::agal::_AGALConverter::DestRegister_obj::__alloc( HX_CTX );
...
{
{
            	HX_STACKFRAME(&_hx_pos_2c9b0c284e068689_534_boot)
