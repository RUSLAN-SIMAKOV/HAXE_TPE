...
HX_DEFINE_STACK_FRAME(_hx_pos_c312f67fa56a379a_961_new,"openfl._internal.formats.agal._AGALConverter.SourceRegister","new",0xbda55cf3,"openfl._internal.formats.agal._AGALConverter.SourceRegister.new","openfl/_internal/formats/agal/AGALConverter.hx",961,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_c312f67fa56a379a_979_toGLSL,"openfl._internal.formats.agal._AGALConverter.SourceRegister","toGLSL",0x1060aa46,"openfl._internal.formats.agal._AGALConverter.SourceRegister.toGLSL","openfl/_internal/formats/agal/AGALConverter.hx",979,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_c312f67fa56a379a_964_parse,"openfl._internal.formats.agal._AGALConverter.SourceRegister","parse",0x9b91a786,"openfl._internal.formats.agal._AGALConverter.SourceRegister.parse","openfl/_internal/formats/agal/AGALConverter.hx",964,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_c312f67fa56a379a_949_boot,"openfl._internal.formats.agal._AGALConverter.SourceRegister","boot",0x2b24f83f,"openfl._internal.formats.agal._AGALConverter.SourceRegister.boot","openfl/_internal/formats/agal/AGALConverter.hx",949,0x323dd368)
namespace openfl{
namespace _internal{
namespace formats{
namespace agal{
...
void SourceRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c312f67fa56a379a_961_new)
            	}
...
bool SourceRegister_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x79585b9b;
}
...
::String SourceRegister_obj::toGLSL(::hx::Null< bool >  __o_emitSwizzle,::hx::Null< int >  __o_offset){
            	...
            	HX_STACKFRAME(&_hx_pos_c312f67fa56a379a_979_toGLSL)
HXLINE( 980)		if ((this->type == 3)) {
HXLINE( 982)			if (::hx::IsEq( this->programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
...
HXLINE(1010)		::String str = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
...
HXLINE(1033)			::String indexRegister = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->itype,this->programType);
...
HX_DEFINE_DYNAMIC_FUNC2(SourceRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister SourceRegister_obj::parse( cpp::Int64Struct v, ::openfl::_internal::formats::agal::_AGALConverter::ProgramType programType,int sourceMask){
            	HX_GC_STACKFRAME(&_hx_pos_c312f67fa56a379a_964_parse)
HXLINE( 965)		 ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister sr =  ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );
...
{
{
            	HX_STACKFRAME(&_hx_pos_c312f67fa56a379a_949_boot)
