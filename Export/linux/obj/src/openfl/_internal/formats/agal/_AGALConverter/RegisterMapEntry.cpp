...
HX_DEFINE_STACK_FRAME(_hx_pos_197adcbc86e81bdc_818_new,"openfl._internal.formats.agal._AGALConverter.RegisterMapEntry","new",0x7586d48e,"openfl._internal.formats.agal._AGALConverter.RegisterMapEntry.new","openfl/_internal/formats/agal/AGALConverter.hx",818,0x323dd368)
namespace openfl{
namespace _internal{
namespace formats{
namespace agal{
...
void RegisterMapEntry_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_197adcbc86e81bdc_818_new)
            	}
...
bool RegisterMapEntry_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x11b37d0a;
}
