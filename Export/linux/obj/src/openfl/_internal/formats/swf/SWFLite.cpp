...
bool SWFLite_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x198b9f7e;
}
...
HXLINE(  54)				if (::Std_obj::isOfType(symbol,( ( ::Dynamic)(::hx::ClassOf< ::openfl::_internal::symbols::SpriteSymbol >()) ))) {
...
HXLINE(  70)			if (::Std_obj::isOfType(symbol,( ( ::Dynamic)(::hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >()) ))) {
