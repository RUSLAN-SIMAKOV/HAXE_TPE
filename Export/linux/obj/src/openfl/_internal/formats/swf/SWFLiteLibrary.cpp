...
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_242_loadImage,"openfl._internal.formats.swf.SWFLiteLibrary","loadImage",0xe4c1c3c0,"openfl._internal.formats.swf.SWFLiteLibrary.loadImage","openfl/_internal/formats/swf/SWFLiteLibrary.hx",242,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_270_unload,"openfl._internal.formats.swf.SWFLiteLibrary","unload",0x0a96a7b4,"openfl._internal.formats.swf.SWFLiteLibrary.unload","openfl/_internal/formats/swf/SWFLiteLibrary.hx",270,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_293___copyChannel,"openfl._internal.formats.swf.SWFLiteLibrary","__copyChannel",0x7aec2859,"openfl._internal.formats.swf.SWFLiteLibrary.__copyChannel","openfl/_internal/formats/swf/SWFLiteLibrary.hx",293,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_309___fromManifest,"openfl._internal.formats.swf.SWFLiteLibrary","__fromManifest",0x1d309e0e,"openfl._internal.formats.swf.SWFLiteLibrary.__fromManifest","openfl/_internal/formats/swf/SWFLiteLibrary.hx",309,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_325___load,"openfl._internal.formats.swf.SWFLiteLibrary","__load",0x9bba03fb,"openfl._internal.formats.swf.SWFLiteLibrary.__load","openfl/_internal/formats/swf/SWFLiteLibrary.hx",325,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_332___loadImage,"openfl._internal.formats.swf.SWFLiteLibrary","__loadImage",0x60453d60,"openfl._internal.formats.swf.SWFLiteLibrary.__loadImage","openfl/_internal/formats/swf/SWFLiteLibrary.hx",332,0x8efd6c01)
...
bool SWFLiteLibrary_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x25654723) {
		...
		return inClassId==(int)0x3db6fa39;
	}
}
...
HXDLIN(  96)					if (::Std_obj::isOfType(symbol1,( ( ::Dynamic)(::hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >()) ))) {
...
HXLINE( 159)					if (::Std_obj::isOfType(symbol1,( ( ::Dynamic)(::hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >()) ))) {
...
HXLINE( 211)			 ::openfl::net::URLLoader loader1 = loader;
HXDLIN( 211)			loader1->load( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,path));
            		}
...
HXDLIN( 232)				if (::Std_obj::isOfType(symbol1,( ( ::Dynamic)(::hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >()) ))) {
HXLINE( 232)					_hx_tmp = (::hx::TCast<  ::openfl::_internal::symbols::BitmapSymbol >::cast(symbol1)->path == id);
            				}
            				else {
...
HXLINE( 244)								_gthis->_hx___copyChannel(image,alpha);
HXLINE( 246)								_gthis->cachedImages->set(id,image);
HXLINE( 247)								_gthis->cachedImages->remove(bitmapSymbol->alpha);
HXLINE( 248)								_gthis->alphaCheck->set(id,true);
HXLINE( 250)								promise->complete(image);
            							}
            							HX_END_LOCAL_FUNC1((void))

            							HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_242_loadImage)
HXLINE( 242)							_gthis->_hx___loadImage(bitmapSymbol->alpha)->onError(promise->error_dyn())->onComplete( ::Dynamic(new _hx_Closure_0(id,_gthis,promise,bitmapSymbol,image)));
            						}
            						HX_END_LOCAL_FUNC1((void))
...
HXLINE( 254)						return promise->future;
            					}
            					else {
HXLINE( 258)						this->alphaCheck->set(id,true);
            					}
            				}
            			}
            		}
HXLINE( 264)		return this->super::loadImage(id);
            	}


void SWFLiteLibrary_obj::unload(){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_270_unload)
HXLINE( 271)		if (::hx::IsNull( this->swf )) {
HXLINE( 271)			return;
            		}
HXLINE( 273)		bool _hx_tmp;
HXDLIN( 273)		if (::openfl::_internal::formats::swf::SWFLite_obj::instances->exists(this->instanceID)) {
HXLINE( 273)			 ::openfl::_internal::formats::swf::SWFLite _hx_tmp1 = ( ( ::openfl::_internal::formats::swf::SWFLite)(::openfl::_internal::formats::swf::SWFLite_obj::instances->get(this->instanceID)) );
HXDLIN( 273)			_hx_tmp = ::hx::IsEq( _hx_tmp1,this->swf );
            		}
            		else {
HXLINE( 273)			_hx_tmp = false;
            		}
HXDLIN( 273)		if (_hx_tmp) {
HXLINE( 275)			::openfl::_internal::formats::swf::SWFLite_obj::instances->remove(this->instanceID);
            		}
HXLINE( 278)		 ::openfl::_internal::symbols::BitmapSymbol bitmap;
HXLINE( 280)		{
HXLINE( 280)			 ::Dynamic symbol = this->swf->symbols->iterator();
HXDLIN( 280)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 280)				 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 282)				if (::Std_obj::isOfType(symbol1,( ( ::Dynamic)(::hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >()) ))) {
HXLINE( 284)					bitmap = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
HXLINE( 285)					::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,bitmap->path);
            				}
            			}
            		}
            	}
...
void SWFLiteLibrary_obj::_hx___copyChannel( ::lime::graphics::Image image, ::lime::graphics::Image alpha){
            	HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_293___copyChannel)
HXLINE( 294)		if (::hx::IsNotNull( alpha )) {
HXLINE( 296)			 ::lime::math::Rectangle _hx_tmp = alpha->get_rect();
HXDLIN( 296)			image->copyChannel(alpha,_hx_tmp, ::lime::math::Vector2_obj::__alloc( HX_CTX ,null(),null()),::lime::graphics::ImageChannel_obj::RED_dyn(),::lime::graphics::ImageChannel_obj::ALPHA_dyn());
            		}
HXLINE( 299)		image->buffer->premultiplied = true;
            	}
...
void SWFLiteLibrary_obj::_hx___fromManifest( ::lime::utils::AssetManifest manifest){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_309___fromManifest)
HXLINE( 310)		this->rootPath = manifest->rootPath;
HXLINE( 311)		this->super::_hx___fromManifest(manifest);
HXLINE( 313)		this->bytesTotal = 0;
HXLINE( 315)		{
HXLINE( 315)			 ::Dynamic id = this->paths->keys();
HXDLIN( 315)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 315)				::String id1 = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 317)				 ::openfl::_internal::formats::swf::SWFLiteLibrary _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 317)				int _hx_tmp1 = _hx_tmp->bytesTotal;
HXDLIN( 317)				_hx_tmp->bytesTotal = (_hx_tmp1 + this->sizes->get(id1));
            			}
            		}
            	}
 ...
 ::lime::app::Future SWFLiteLibrary_obj::_hx___load(){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_325___load)
HXDLIN( 325)		return this->super::load();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SWFLiteLibrary_obj,_hx___load,return )
 ...
 ::lime::app::Future SWFLiteLibrary_obj::_hx___loadImage(::String id){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_332___loadImage)
HXDLIN( 332)		return this->super::loadImage(id);
            	}
