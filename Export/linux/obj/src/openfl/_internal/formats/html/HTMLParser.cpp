...
bool HTMLParser_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x729c6c29;
}
...
HXLINE(  81)					::String segment = segments->__get(_g2);
HXDLIN(  81)					_g2 = (_g2 + 1);
HXLINE(  83)					if ((segment == HX_("",00,00,00,00))) {
HXLINE(  83)						continue;
            					}
HXLINE(  85)					bool isClosingTag = (segment.substr(0,1) == HX_("/",2f,00,00,00));
HXLINE(  86)					int tagEndIndex = segment.indexOf(HX_(">",3e,00,00,00),null());
HXLINE(  87)					int start = (tagEndIndex + 1);
HXLINE(  88)					int spaceIndex = segment.indexOf(HX_(" ",20,00,00,00),null());
...
HXDLIN(  89)					::String tagName3 = segment.substring(tagName,tagName1);
...
HXLINE( 111)						if ((start < segment.length)) {
HXLINE( 113)							sub = segment.substr(start,null());
...
HXLINE( 128)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexHref->match(segment)) {
...
HXLINE( 146)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexFace->match(segment)) {
...
HXLINE( 151)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexColor->match(segment)) {
...
HXLINE( 156)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexSize->match(segment)) {
...
HXLINE( 161)										_hx_tmp = ::hx::IsEq( firstChar,45 );
            									}
            									else {
...
HXLINE( 134)									_hx_tmp = !(noLineBreak);
            								}
            								else {
...
HXLINE( 139)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexAlign->match(segment)) {
...
HXLINE( 182)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexBlockIndent->match(segment)) {
...
HXLINE( 187)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexIndent->match(segment)) {
...
HXLINE( 192)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexLeading->match(segment)) {
...
HXLINE( 197)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexLeftMargin->match(segment)) {
...
HXLINE( 202)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexRightMargin->match(segment)) {
...
HXLINE( 207)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexTabStops->match(segment)) {
...
HXLINE( 212)									{
HXLINE( 212)										int _g = 0;
HXDLIN( 212)										while((_g < values->length)){
HXLINE( 212)											::String stop = values->__get(_g);
HXDLIN( 212)											_g = (_g + 1);
...
HXLINE( 224)							if ((start < segment.length)) {
HXLINE( 226)								sub = segment.substring(start,null());
...
HXLINE( 234)							textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__alloc( HX_CTX ,format,value.length,(value.length + segment.length)));
HXLINE( 235)							value = (value + segment);
