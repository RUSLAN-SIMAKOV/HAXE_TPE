...
bool ShapeSymbol_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x6ec9976b) {
		...
		return inClassId==(int)0x76ff4de6;
	}
}
...
HXDLIN(  64)						 ::openfl::geom::Matrix matrix = command->_hx_getObject(4).StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE(  65)						graphics->beginGradientFill(fillType,colors,alphas,ratios,matrix,spreadMethod,interpolationMethod,focalPointRatio);
            					}
            					break;
            					case (int)3: {
...
HXDLIN(  74)						 ::Dynamic alpha = command->_hx_getObject(2);
HXDLIN(  74)						 ::Dynamic color = command->_hx_getObject(1);
HXDLIN(  74)						 ::Dynamic thickness = command->_hx_getObject(0);
HXLINE(  75)						if (::hx::IsNotNull( thickness )) {
HXLINE(  77)							graphics->lineStyle(thickness,color,alpha,pixelHinting,scaleMode,caps,joints,miterLimit);
            						}
            						else {
...
HXLINE(  86)						graphics->lineTo(x,y);
            					...
            					break;
            					case (int)7: {
HXLINE(  88)						Float y = command->_hx_getFloat(1);
HXDLIN(  88)						Float x = command->_hx_getFloat(0);
HXLINE(  89)						graphics->moveTo(x,y);
            					}
            					break;
            				}
            			}
