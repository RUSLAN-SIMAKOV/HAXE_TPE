...
bool SpriteSymbol_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x67001eac) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x67001eac;
	} else {
...
HXLINE(  44)			_hx_tmp = ::hx::IsNotNull( this->baseClassName );
            		}
            		else {
...
HXLINE(  48)			bool _hx_tmp = ::hx::IsNull( symbolType );
            		}
