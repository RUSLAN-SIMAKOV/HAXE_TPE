...
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_186_get_positions,"openfl._internal.text.TextLayout","get_positions",0xe8c451db,"openfl._internal.text.TextLayout.get_positions","openfl/_internal/text/TextLayout.hx",186,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_198_get_direction,"openfl._internal.text.TextLayout","get_direction",0x28b2c070,"openfl._internal.text.TextLayout.get_direction","openfl/_internal/text/TextLayout.hx",198,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_202_set_direction,"openfl._internal.text.TextLayout","set_direction",0x6db8a27c,"openfl._internal.text.TextLayout.set_direction","openfl/_internal/text/TextLayout.hx",202,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_212_set_font,"openfl._internal.text.TextLayout","set_font",0x6d4a06b2,"openfl._internal.text.TextLayout.set_font","openfl/_internal/text/TextLayout.hx",212,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_223_get_glyphs,"openfl._internal.text.TextLayout","get_glyphs",0x88cb4276,"openfl._internal.text.TextLayout.get_glyphs","openfl/_internal/text/TextLayout.hx",223,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_236_get_language,"openfl._internal.text.TextLayout","get_language",0x8c8bb347,"openfl._internal.text.TextLayout.get_language","openfl/_internal/text/TextLayout.hx",236,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_240_set_language,"openfl._internal.text.TextLayout","set_language",0xa184d6bb,"openfl._internal.text.TextLayout.set_language","openfl/_internal/text/TextLayout.hx",240,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_251_get_script,"openfl._internal.text.TextLayout","get_script",0x21d2973a,"openfl._internal.text.TextLayout.get_script","openfl/_internal/text/TextLayout.hx",251,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_255_set_script,"openfl._internal.text.TextLayout","set_script",0x255035ae,"openfl._internal.text.TextLayout.set_script","openfl/_internal/text/TextLayout.hx",255,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_265_set_size,"openfl._internal.text.TextLayout","set_size",0x75dd49a4,"openfl._internal.text.TextLayout.set_size","openfl/_internal/text/TextLayout.hx",265,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_274_set_text,"openfl._internal.text.TextLayout","set_text",0x76837590,"openfl._internal.text.TextLayout.set_text","openfl/_internal/text/TextLayout.hx",274,0x21621597)
...
bool TextLayout_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x69612cac;
}
...
HXLINE( 148)			 ::Dynamic _hx_tmp = this->_hx___hbBuffer;
HXDLIN( 148)			Float _hx_tmp1 = (uintptr_t)this->text.wc_str();
HXDLIN( 148)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF16(_hx_tmp,_hx_tmp1,this->text.length,0,-1);
...
HXLINE( 156)				_hx_tmp2 = ::hx::IsNotNull( _positions );
            			}
            			else {
...
HXLINE( 168)						{
HXLINE( 168)							int _g1 = (lastCluster + 1);
HXDLIN( 168)							int _g2 = info->cluster;
HXDLIN( 168)							while((_g1 < _g2)){
HXLINE( 168)								_g1 = (_g1 + 1);
HXDLIN( 168)								int j = (_g1 - 1);
HXLINE( 172)								::Array< ::Dynamic> _hx_tmp = this->get_positions();
HXDLIN( 172)								 ::lime::math::Vector2 _hx_tmp1 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 172)								_hx_tmp->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp1, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 175)						::Array< ::Dynamic> _hx_tmp = this->get_positions();
HXDLIN( 175)						int info1 = info->codepoint;
HXDLIN( 175)						 ::lime::math::Vector2 _hx_tmp1 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 175)						_hx_tmp->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp1, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));
...
::Array< ::Dynamic> TextLayout_obj::get_positions(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_186_get_positions)
...
int TextLayout_obj::get_direction(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_198_get_direction)
...
int TextLayout_obj::set_direction(int value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_202_set_direction)
...
HX_DEFINE_DYNAMIC_FUNC1(TextLayout_obj,set_direction,return )
 ...
 ::lime::text::Font TextLayout_obj::set_font( ::lime::text::Font value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_212_set_font)
...
::Array< int > TextLayout_obj::get_glyphs(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_223_get_glyphs)
...
HXLINE( 226)				 ::openfl::_internal::text::GlyphPosition position = _g1->__get(_g).StaticCast<  ::openfl::_internal::text::GlyphPosition >();
HXDLIN( 226)				_g = (_g + 1);
...
::String TextLayout_obj::get_language(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_236_get_language)
...
::String TextLayout_obj::set_language(::String value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_240_set_language)
...
::String TextLayout_obj::get_script(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_251_get_script)
...
::String TextLayout_obj::set_script(::String value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_255_set_script)
...
int TextLayout_obj::set_size(int value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_265_set_size)
...
::String TextLayout_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_274_set_text)
