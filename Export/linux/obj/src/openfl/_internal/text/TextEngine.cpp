...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(TextEngine_obj,getFont,return )
 ...
 ::openfl::text::Font TextEngine_obj::getFontInstance( ::openfl::text::TextFormat format){
            	HX_GC_STACKFRAME(&_hx_pos_fa7d844c6c93a0ee_355_getFontInstance)
...
HXLINE( 374)			::String _hx_switch_0 = format->font;
            			if (  (_hx_switch_0==HX_("_sans",32,a0,5e,ff)) ){
HXLINE( 413)				fontList = ::Array_obj< ::String >::__new(1)->init(0, ::sys::io::Process_obj::__alloc( HX_CTX ,HX_("fc-match",f5,ea,18,e0),::Array_obj< ::String >::fromData( _hx_array_data_a0887a60_139,2),null())->_hx_stdout->readLine());
...
HXLINE( 420)				goto _hx_goto_135;
            			...
            			if (  (_hx_switch_0==HX_("_typewriter",0c,5e,52,94)) ){
HXLINE( 461)				fontList = ::Array_obj< ::String >::__new(1)->init(0, ::sys::io::Process_obj::__alloc( HX_CTX ,HX_("fc-match",f5,ea,18,e0),::Array_obj< ::String >::fromData( _hx_array_data_a0887a60_140,2),null())->_hx_stdout->readLine());
...
HXLINE( 524)		fontList = ::Array_obj< ::String >::__new(1)->init(0, ::sys::io::Process_obj::__alloc( HX_CTX ,HX_("fc-match",f5,ea,18,e0),::Array_obj< ::String >::fromData( _hx_array_data_a0887a60_141,2),null())->_hx_stdout->readLine());
HXLINE( 534)		{
HXLINE( 534)			int _g = 0;
