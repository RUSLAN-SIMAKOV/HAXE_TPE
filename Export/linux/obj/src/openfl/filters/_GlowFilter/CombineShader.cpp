...
HX_DEFINE_STACK_FRAME(_hx_pos_bfba60fe12c23493_601_new,"openfl.filters._GlowFilter.CombineShader","new",0x929ab2fb,"openfl.filters._GlowFilter.CombineShader.new","openfl/filters/GlowFilter.hx",601,0x5f568606)
...
void CombineShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_bfba60fe12c23493_601_new)
...
HXLINE( 602)		super::__construct(null());
HXLINE( 604)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_1cf91989_1,2);
HXLINE( 574)		this->_hx___isGenerated = true;
HXDLIN( 574)		this->_hx___initGL();
            	}
