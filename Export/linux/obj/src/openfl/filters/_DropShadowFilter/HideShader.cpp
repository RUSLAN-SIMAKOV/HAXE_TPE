...
HX_DEFINE_STACK_FRAME(_hx_pos_07af302b8e600910_573_new,"openfl.filters._DropShadowFilter.HideShader","new",0x8120a732,"openfl.filters._DropShadowFilter.HideShader.new","openfl/filters/DropShadowFilter.hx",573,0x048fdea4)
...
void HideShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_07af302b8e600910_573_new)
...
HXLINE( 574)		super::__construct(null());
HXLINE( 576)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_2554e640_1,2);
HXLINE( 549)		this->_hx___isGenerated = true;
HXDLIN( 549)		this->_hx___initGL();
            	}
