...
HX_DEFINE_STACK_FRAME(_hx_pos_1c37e03b5548415e_215_new,"openfl.filters.ConvolutionFilter","new",0xfeba0f71,"openfl.filters.ConvolutionFilter.new","openfl/filters/ConvolutionFilter.hx",215,0x8cb91f21)
HX_LOCAL_STACK_FRAME(_hx_pos_1c37e03b5548415e_233_clone,"openfl.filters.ConvolutionFilter","clone",0x5c23f8ae,"openfl.filters.ConvolutionFilter.clone","openfl/filters/ConvolutionFilter.hx",233,0x8cb91f21)
HX_LOCAL_STACK_FRAME(_hx_pos_1c37e03b5548415e_237___initShader,"openfl.filters.ConvolutionFilter","__initShader",0x77456c44,"openfl.filters.ConvolutionFilter.__initShader","openfl/filters/ConvolutionFilter.hx",237,0x8cb91f21)
HX_LOCAL_STACK_FRAME(_hx_pos_1c37e03b5548415e_251_get_matrix,"openfl.filters.ConvolutionFilter","get_matrix",0x1d18db19,"openfl.filters.ConvolutionFilter.get_matrix","openfl/filters/ConvolutionFilter.hx",251,0x8cb91f21)
HX_LOCAL_STACK_FRAME(_hx_pos_1c37e03b5548415e_255_set_matrix,"openfl.filters.ConvolutionFilter","set_matrix",0x2096798d,"openfl.filters.ConvolutionFilter.set_matrix","openfl/filters/ConvolutionFilter.hx",255,0x8cb91f21)
...
void ConvolutionFilter_obj::__construct(::hx::Null< int >  __o_matrixX,::hx::Null< int >  __o_matrixY,::Array< Float > matrix,::hx::Null< Float >  __o_divisor,::hx::Null< Float >  __o_bias,::hx::Null< bool >  __o_preserveAlpha,::hx::Null< bool >  __o_clamp,::hx::Null< int >  __o_color,::hx::Null< Float >  __o_alpha){
            	...
            	HX_STACKFRAME(&_hx_pos_1c37e03b5548415e_215_new)
HXLINE( 216)		super::__construct();
HXLINE( 218)		this->matrixX = matrixX;
HXLINE( 219)		this->matrixY = matrixY;
HXLINE( 220)		this->_hx___matrix = matrix;
HXLINE( 221)		this->divisor = divisor;
HXLINE( 222)		this->bias = bias;
HXLINE( 223)		this->preserveAlpha = preserveAlpha;
HXLINE( 224)		this->clamp = clamp;
HXLINE( 225)		this->color = color;
HXLINE( 226)		this->alpha = alpha;
HXLINE( 228)		this->_hx___numShaderPasses = 1;
            	}
...
bool ConvolutionFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter ConvolutionFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_1c37e03b5548415e_233_clone)
HXDLIN( 233)		return  ::openfl::filters::ConvolutionFilter_obj::__alloc( HX_CTX ,this->matrixX,this->matrixY,this->_hx___matrix,this->divisor,this->bias,this->preserveAlpha,this->clamp,this->color,this->alpha);
            	}
 ...
 ::openfl::display::Shader ConvolutionFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_STACKFRAME(&_hx_pos_1c37e03b5548415e_237___initShader)
HXLINE( 239)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uConvoMatrix->value = this->get_matrix();
HXLINE( 240)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uDivisor->value[0] = this->divisor;
HXLINE( 241)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uBias->value[0] = this->bias;
HXLINE( 242)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uPreserveAlpha->value[0] = this->preserveAlpha;
HXLINE( 245)		return ::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader;
            	}


::Array< Float > ConvolutionFilter_obj::get_matrix(){
            	HX_STACKFRAME(&_hx_pos_1c37e03b5548415e_251_get_matrix)
HXDLIN( 251)		return this->_hx___matrix;
            	}
...
::Array< Float > ConvolutionFilter_obj::set_matrix(::Array< Float > v){
            	HX_STACKFRAME(&_hx_pos_1c37e03b5548415e_255_set_matrix)
HXLINE( 256)		if (::hx::IsNull( v )) {
HXLINE( 258)			v = ::Array_obj< Float >::fromData( _hx_array_data_75e782ff_5,9);
            		}
HXLINE( 261)		if ((v->length != 9)) {
HXLINE( 263)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Only a 3x3 matrix is supported",f2,31,34,62)));
            		}
HXLINE( 266)		return (this->_hx___matrix = v);
            	}
