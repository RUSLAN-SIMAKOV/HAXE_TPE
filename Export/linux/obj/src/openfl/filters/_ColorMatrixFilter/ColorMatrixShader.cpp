...
HX_DEFINE_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_273_new,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","new",0xf11da59b,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.new","openfl/filters/ColorMatrixFilter.hx",273,0xb64128b5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_283_init,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","init",0x058bf975,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.init","openfl/filters/ColorMatrixFilter.hx",283,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_246_boot,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","boot",0x00ec4297,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.boot","openfl/filters/ColorMatrixFilter.hx",246,0xb64128b5)
namespace openfl{
namespace filters{
namespace _ColorMatrixFilter{

void ColorMatrixShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_273_new)
...
HXLINE( 274)		super::__construct(null());
HXLINE( 277)		this->uMultipliers->value = ::Array_obj< Float >::fromData( _hx_array_data_a1263c29_1,16);
HXLINE( 278)		this->uOffsets->value = ::Array_obj< Float >::fromData( _hx_array_data_a1263c29_2,4);
HXLINE( 246)		this->_hx___isGenerated = true;
HXDLIN( 246)		this->_hx___initGL();
            	}
...
void ColorMatrixShader_obj::init(::Array< Float > matrix){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_283_init)
HXLINE( 285)		::Array< Float > multipliers = this->uMultipliers->value;
HXLINE( 286)		::Array< Float > offsets = this->uOffsets->value;
HXLINE( 288)		multipliers[0] = matrix->__get(0);
HXLINE( 289)		multipliers[1] = matrix->__get(1);
HXLINE( 290)		multipliers[2] = matrix->__get(2);
HXLINE( 291)		multipliers[3] = matrix->__get(3);
HXLINE( 292)		multipliers[4] = matrix->__get(5);
HXLINE( 293)		multipliers[5] = matrix->__get(6);
HXLINE( 294)		multipliers[6] = matrix->__get(7);
HXLINE( 295)		multipliers[7] = matrix->__get(8);
HXLINE( 296)		multipliers[8] = matrix->__get(10);
HXLINE( 297)		multipliers[9] = matrix->__get(11);
HXLINE( 298)		multipliers[10] = matrix->__get(12);
HXLINE( 299)		multipliers[11] = matrix->__get(13);
HXLINE( 300)		multipliers[12] = matrix->__get(15);
HXLINE( 301)		multipliers[13] = matrix->__get(16);
HXLINE( 302)		multipliers[14] = matrix->__get(17);
HXLINE( 303)		multipliers[15] = matrix->__get(18);
HXLINE( 305)		offsets[0] = (matrix->__get(4) / ((Float)255.0));
HXLINE( 306)		offsets[1] = (matrix->__get(9) / ((Float)255.0));
HXLINE( 307)		offsets[2] = (matrix->__get(14) / ((Float)255.0));
HXLINE( 308)		offsets[3] = (matrix->__get(19) / ((Float)255.0));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_246_boot)
HXDLIN( 246)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
