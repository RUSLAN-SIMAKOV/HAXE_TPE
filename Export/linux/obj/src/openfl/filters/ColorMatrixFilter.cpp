...
HXLINE( 178)				{
HXLINE( 178)					int _g1 = ::Std_obj::_hx_int(sourceRect->x);
HXDLIN( 178)					int _g2 = ::Std_obj::_hx_int(sourceRect->width);
HXDLIN( 178)					while((_g1 < _g2)){
HXLINE( 178)						_g1 = (_g1 + 1);
HXDLIN( 178)						int column = (_g1 - 1);
...
HXDLIN( 183)									sourcePixel = (((((r & 255) << 24) | ((g & 255) << 16)) | ((b & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 3))) & 255)) ) & 255));
            								...
            								break;
            								case (int)1: {
HXLINE( 183)									int r = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 1))) & 255)) );
HXDLIN( 183)									int g = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 2))) & 255)) );
HXDLIN( 183)									int b = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 3))) & 255)) );
HXDLIN( 183)									sourcePixel = (((((r & 255) << 24) | ((g & 255) << 16)) | ((b & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + sourceOffset)) & 255)) ) & 255));
            								}
            								break;
            								case (int)2: {
HXLINE( 183)									int r = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 2))) & 255)) );
HXDLIN( 183)									int g = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 1))) & 255)) );
HXDLIN( 183)									int b = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + sourceOffset)) & 255)) );
HXDLIN( 183)									sourcePixel = (((((r & 255) << 24) | ((g & 255) << 16)) | ((b & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 3))) & 255)) ) & 255));
            								}
            								break;
            							}
...
HXDLIN( 183)										int r = ( (int)(( ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + ::Math_obj::round((( (Float)((::hx::UShr(sourcePixel,24) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 183)										 ::lime::utils::ArrayBufferView this2 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 183)										int g = ( (int)(( ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + ::Math_obj::round((( (Float)((::hx::UShr(sourcePixel,16) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 183)										 ::lime::utils::ArrayBufferView this3 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 183)										sourcePixel = (((((r & 255) << 24) | ((g & 255) << 16)) | ((( (int)(( ::__hxcpp_memory_get_byte(this3->buffer->b,(this3->byteOffset + ::Math_obj::round((( (Float)((::hx::UShr(sourcePixel,8) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) ) & 255) << 8)) | ((sourcePixel & 255) & 255));
            									}
            								}
            							}
            						}
...
HXLINE( 209)										 ::lime::utils::ArrayBufferView this1 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___alpha16;
HXDLIN( 209)										::lime::math::_RGBA::RGBA_Impl__obj::a16 = ( (int)( ::__hxcpp_memory_get_ui32(this1->buffer->b,(this1->byteOffset + ((destPixel & 255) * 4)))) );
...
HXDLIN( 209)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val3);
            								...
            								case (int)1: {
HXLINE( 209)									{
HXLINE( 209)										int val = (destPixel & 255);
HXDLIN( 209)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val);
            									}
HXDLIN( 209)									{
HXLINE( 209)										int val1 = (::hx::UShr(destPixel,24) & 255);
HXDLIN( 209)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),val1);
            									}
HXDLIN( 209)									{
HXLINE( 209)										int val2 = (::hx::UShr(destPixel,16) & 255);
HXDLIN( 209)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),val2);
            									}
HXDLIN( 209)									{
HXLINE( 209)										int val3 = (::hx::UShr(destPixel,8) & 255);
HXDLIN( 209)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val3);
            									}
            								}
            								break;
            								case (int)2: {
HXLINE( 209)									{
HXLINE( 209)										int val = (::hx::UShr(destPixel,8) & 255);
HXDLIN( 209)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val);
            									}
HXDLIN( 209)									{
HXLINE( 209)										int val1 = (::hx::UShr(destPixel,16) & 255);
...
HXDLIN( 209)									{
HXLINE( 209)										int val2 = (::hx::UShr(destPixel,24) & 255);
HXDLIN( 209)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),val2);
            									}
HXDLIN( 209)									{
HXLINE( 209)										int val3 = (destPixel & 255);
