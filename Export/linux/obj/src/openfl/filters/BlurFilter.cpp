...
HX_DEFINE_STACK_FRAME(_hx_pos_6e95f8db175a4230_162_new,"openfl.filters.BlurFilter","new",0x2ff6acc2,"openfl.filters.BlurFilter.new","openfl/filters/BlurFilter.hx",162,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_176_clone,"openfl.filters.BlurFilter","clone",0xcbbf4c3f,"openfl.filters.BlurFilter.clone","openfl/filters/BlurFilter.hx",176,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_181___applyFilter,"openfl.filters.BlurFilter","__applyFilter",0x511b0b88,"openfl.filters.BlurFilter.__applyFilter","openfl/filters/BlurFilter.hx",181,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_194___initShader,"openfl.filters.BlurFilter","__initShader",0xc19d1cd3,"openfl.filters.BlurFilter.__initShader","openfl/filters/BlurFilter.hx",194,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_216_get_blurX,"openfl.filters.BlurFilter","get_blurX",0xeb11be0a,"openfl.filters.BlurFilter.get_blurX","openfl/filters/BlurFilter.hx",216,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_220_set_blurX,"openfl.filters.BlurFilter","set_blurX",0xce62aa16,"openfl.filters.BlurFilter.set_blurX","openfl/filters/BlurFilter.hx",220,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_233_get_blurY,"openfl.filters.BlurFilter","get_blurY",0xeb11be0b,"openfl.filters.BlurFilter.get_blurY","openfl/filters/BlurFilter.hx",233,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_237_set_blurY,"openfl.filters.BlurFilter","set_blurY",0xce62aa17,"openfl.filters.BlurFilter.set_blurY","openfl/filters/BlurFilter.hx",237,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_250_get_quality,"openfl.filters.BlurFilter","get_quality",0xa28f7338,"openfl.filters.BlurFilter.get_quality","openfl/filters/BlurFilter.hx",250,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_254_set_quality,"openfl.filters.BlurFilter","set_quality",0xacfc7a44,"openfl.filters.BlurFilter.set_quality","openfl/filters/BlurFilter.hx",254,0x46563eac)
...
void BlurFilter_obj::__construct(::hx::Null< Float >  __o_blurX,::hx::Null< Float >  __o_blurY,::hx::Null< int >  __o_quality){
            	...
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_162_new)
HXLINE( 163)		super::__construct();
HXLINE( 165)		this->set_blurX(blurX);
HXLINE( 166)		this->set_blurY(blurY);
HXLINE( 167)		this->set_quality(quality);
HXLINE( 169)		this->_hx___needSecondBitmapData = true;
HXLINE( 170)		this->_hx___preserveObject = false;
HXLINE( 171)		this->_hx___renderDirty = true;
            	}
...
bool BlurFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter BlurFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_6e95f8db175a4230_176_clone)
HXDLIN( 176)		return  ::openfl::filters::BlurFilter_obj::__alloc( HX_CTX ,this->_hx___blurX,this->_hx___blurY,this->_hx___quality);
            	}
 ...
 ::openfl::display::BitmapData BlurFilter_obj::_hx___applyFilter( ::openfl::display::BitmapData bitmapData, ::openfl::display::BitmapData sourceBitmapData, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_181___applyFilter)
HXLINE( 183)		int timer = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 183)		Float time;
HXDLIN( 183)		if ((timer > 0)) {
HXLINE( 183)			time = (( (Float)(timer) ) / ( (Float)(1000) ));
            		}
            		else {
HXLINE( 183)			time = ( (Float)(0) );
            		}
HXLINE( 184)		 ::lime::graphics::Image bitmapData1 = bitmapData->image;
HXDLIN( 184)		 ::lime::graphics::Image sourceBitmapData1 = sourceBitmapData->image;
HXDLIN( 184)		 ::lime::math::Rectangle finalImage = sourceRect->_hx___toLimeRectangle();
HXDLIN( 184)		 ::lime::math::Vector2 finalImage1 = destPoint->_hx___toLimeVector2();
HXDLIN( 184)		 ::lime::graphics::Image finalImage2 = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,null(),null());
HXLINE( 186)		int timer1 = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 186)		Float elapsed;
HXDLIN( 186)		if ((timer1 > 0)) {
HXLINE( 186)			elapsed = (( (Float)(timer1) ) / ( (Float)(1000) ));
            		}
            		else {
HXLINE( 186)			elapsed = ( (Float)(0) );
            		}
HXDLIN( 186)		Float elapsed1 = (elapsed - time);
HXLINE( 188)		if (::hx::IsEq( finalImage2,bitmapData->image )) {
HXLINE( 188)			return bitmapData;
            		}
HXLINE( 190)		return sourceBitmapData;
            	}
 ...
 ::openfl::display::Shader BlurFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_194___initShader)
HXLINE( 196)		if ((pass < this->_hx___horizontalPasses)) {
HXLINE( 198)			Float scale = ::Math_obj::pow(((Float)0.5),( (Float)((pass >> 1)) ));
HXLINE( 199)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[0] = (this->get_blurX() * scale);
HXLINE( 200)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[1] = ( (Float)(0) );
            		}
            		else {
HXLINE( 204)			Float scale = ::Math_obj::pow(((Float)0.5),( (Float)(((pass - this->_hx___horizontalPasses) >> 1)) ));
HXLINE( 205)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[0] = ( (Float)(0) );
HXLINE( 206)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[1] = (this->get_blurY() * scale);
            		}
HXLINE( 210)		return ::openfl::filters::BlurFilter_obj::_hx___blurShader;
            	}


Float BlurFilter_obj::get_blurX(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_216_get_blurX)
HXDLIN( 216)		return this->_hx___blurX;
            	}
...
Float BlurFilter_obj::set_blurX(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_220_set_blurX)
HXLINE( 221)		if ((value != this->_hx___blurX)) {
HXLINE( 223)			this->_hx___blurX = value;
HXLINE( 224)			this->_hx___renderDirty = true;
HXLINE( 225)			int _hx_tmp;
HXDLIN( 225)			if ((value > 0)) {
HXLINE( 225)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 225)				_hx_tmp = 0;
            			}
HXDLIN( 225)			this->_hx___leftExtension = _hx_tmp;
HXLINE( 226)			this->_hx___rightExtension = this->_hx___leftExtension;
            		}
...
Float BlurFilter_obj::get_blurY(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_233_get_blurY)
HXDLIN( 233)		return this->_hx___blurY;
            	}
...
Float BlurFilter_obj::set_blurY(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_237_set_blurY)
HXLINE( 238)		if ((value != this->_hx___blurY)) {
HXLINE( 240)			this->_hx___blurY = value;
HXLINE( 241)			this->_hx___renderDirty = true;
HXLINE( 242)			int _hx_tmp;
HXDLIN( 242)			if ((value > 0)) {
HXLINE( 242)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 242)				_hx_tmp = 0;
            			}
HXDLIN( 242)			this->_hx___topExtension = _hx_tmp;
HXLINE( 243)			this->_hx___bottomExtension = this->_hx___topExtension;
            		}
...
int BlurFilter_obj::get_quality(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_250_get_quality)
HXDLIN( 250)		return this->_hx___quality;
            	}
...
int BlurFilter_obj::set_quality(int value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_254_set_quality)
HXLINE( 257)		int _hx_tmp;
HXDLIN( 257)		if ((this->_hx___blurX <= 0)) {
HXLINE( 257)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 257)			_hx_tmp = (::Math_obj::round((this->_hx___blurX * (( (Float)(value) ) / ( (Float)(4) )))) + 1);
            		}
HXDLIN( 257)		this->_hx___horizontalPasses = _hx_tmp;
HXLINE( 258)		int _hx_tmp1;
HXDLIN( 258)		if ((this->_hx___blurY <= 0)) {
HXLINE( 258)			_hx_tmp1 = 0;
            		}
            		else {
HXLINE( 258)			_hx_tmp1 = (::Math_obj::round((this->_hx___blurY * (( (Float)(value) ) / ( (Float)(4) )))) + 1);
            		}
HXDLIN( 258)		this->_hx___verticalPasses = _hx_tmp1;
HXLINE( 260)		this->_hx___numShaderPasses = (this->_hx___horizontalPasses + this->_hx___verticalPasses);
HXLINE( 262)		if ((value != this->_hx___quality)) {
HXLINE( 262)			this->_hx___renderDirty = true;
            		}
HXLINE( 263)		return (this->_hx___quality = value);
            	}
