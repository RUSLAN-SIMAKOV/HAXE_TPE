...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HelloOpenfl", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HelloOpenfl", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "HelloOpenfl";
		app.meta["name"] = "HelloOpenfl";
		app.meta["packageName"] = "com.sample.helloopenfl";
